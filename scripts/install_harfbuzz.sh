...
cmake -S harfbuzz-10.4.0 -B build-harfbuzz -DCMAKE_INSTALL_PREFIX="$INSTALL_PREFIX" -DCMAKE_PREFIX_PATH="$INSTALL_PREFIX" -DBUILD_SHARED_LIBS=OFF -DHB_HAVE_FREETYPE=ON -DHB_HAVE_GLIB=OFF -DHB_HAVE_CAIRO=OFF -DHB_BUILD_SUBSET=OFF -DHB_HAVE_ICU=OFF
