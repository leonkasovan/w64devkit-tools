...
cmake -S SDL_image-release-2.8.12 -B build_sdl2image -DCMAKE_INSTALL_PREFIX="$INSTALL_PREFIX" -DCMAKE_PREFIX_PATH="$INSTALL_PREFIX" -DBUILD_SHARED_LIBS=OFF -DSDL2IMAGE_SAMPLES=OFF -DSDL2IMAGE_TESTS=OFF -DSDL2IMAGE_PNG_STB=OFF -DSDL2IMAGE_JPEG_STB=OFF -DSDL2IMAGE_WEBP_STB=OFF -DSDL2IMAGE_PNG=ON -DSDL2IMAGE_WEBP=ON -DSDL2IMAGE_JPEG=ON
